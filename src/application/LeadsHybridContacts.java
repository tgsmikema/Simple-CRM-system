...
public class LeadsHybridContacts {
	...
	public String getLead_created_by() {
		return lead_created_by;
	}
	public void setLead_created_by(String lead_created_by) {
		this.lead_created_by = lead_created_by;
	}
	public Timestamp getLead_created_date_and_time() {
		return lead_created_date_and_time;
	}
	public void setLead_created_date_and_time(Timestamp lead_created_date_and_time) {
		this.lead_created_date_and_time = lead_created_date_and_time;
	}
